...
//let frutas = [{ fruta: 'Maça'}, { fruta: 'Pera' }, { fruta: 'Banana' }, { fruta: 'Laranja' }, { fruta: 'Uva' }];


//produtos.push({id: 101, nome: "Água Mineral 2L", preco_venda: 1.59, preco_compra: .80, estoque: 100, rotatividade: "alta", curva_abc: "B" });// Adiciona um novo produto ao final da lista de produtos usando o método push().

//produtos.splice(13, 1); // Remove 13 produtos a partir do índice 13 usando o método splice().
...
//let custoEstoque = produtos.reduce((acumulador, produto) => acumulador + (produto.preco_compra * produto.estoque), 0); // Calcula o custo total do estoque multiplicando o preço de compra pelo estoque de cada produto e somando os resultados usando o método reduce().

//custoEstoque = custoEstoque.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' }); // Formata o valor do custo total do estoque para o formato de moeda brasileira usando o método toLocaleString().


//let totalVenda = produtos.reduce((acumulador, produto) => acumulador + (produto.preco_venda * produto.estoque), 0); // Calcula o valor total de venda do estoque multiplicando o preço de venda pelo estoque de cada produto e somando os resultados usando o método reduce().

//totalVenda = totalVenda.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' }); // Formata o valor do total de venda para o formato de moeda brasileira usando o método toLocaleString().
